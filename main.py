...
def messages(message):
    ...
    mes = {
        0: {
            "message": "Давай начнём. Расскажи немного о своём состоянии. Насколько ты устал? Оцени по шкале от 1 до 3, где 1 - бодр и полон сил, "
                       "3 - готов упасть и лежать.",
            "buttons": True,
            "wait_ans": True
        },
        1: {
            "message": "Понял тебя. А как сильно ты сейчас нуждаешься в моральной поддержке? Оцени по шкале от 1 до 3, где 1 - у меня всё хорошо, "
                       "3 - мне очень плохо и одиноко.",
            "buttons": True,
            "wait_ans": True
        },
        2: {
            "message": "Хм, ясно. И последний вопрос. Можно ли сказать, что сегодня не твой день? Оцени по шкале от 1 до 3, где 1 - нет, всё идёт "
        ...
        4: {
            "message": "Спасибо за ответы). Скоро в 4 холле появится Калейдоскоп душ, где ты сможешь увидеть "
                       "визуализацию настроений всех учасников смены. Пиши снова, когда захочешь.",
            "buttons": False,
            "wait_ans": False
        },
        5: {
            "message": "Как прошло твоё время? Ты доволен собой?Оцени по шкале от 1 до 3, где 1 - Я доволен собой, 3 - Недовольнее некуда.",
            "buttons": True,
            "wait_ans": True
        },
        6: {
            "message": "Хорошо, следующий вопрос. На сколько ты бодр?Оцени по шкале от 1 до 3, где 1 - Готов бегать всю ночь, 3 - Коала бодрее.",
            "buttons": True,
            "wait_ans": True
        },
        7: {
            "message": "Окей, подходим к концу. Готов ли ты сейчас поболтать с кем-нибудь.Оцени по шкале от 1 до 3, где 1 - оставьте меня в покое, "
                       "3 - да, жажду общения.",
            "buttons": True,
            "wait_ans": True
        },
        ...
        9: {
            "message": "Спасибо что написал). Буду ждать следующего диалога с тобой. Скоро в 4 холле появится "
