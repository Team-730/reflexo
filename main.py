...
def start(message):
    bot.send_message(message.chat.id, f'Привет, {message.from_user.first_name}! Я бот, созданный чтобы вы могли выразтть ваши эмоции и поделиться своими проблемами или успехами.')
