...
def get_puzzle(matrix):
    ...
    dwg.save()
    #bashCommand = 'sshpass -p "F3Btfet&" scp x1.svg tn23m_reflexo@reflexo.space:x1.svg'
    #process = subprocess.Popen(['sshpass','-p "F3Btfet&"', 'scp', '-o BatchMode=yes',
    #                            'x1.svg',
    #                            'tn23m_reflexo@reflexo.space:x1.svg'],
